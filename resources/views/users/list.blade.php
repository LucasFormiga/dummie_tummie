        ...
        @foreach($users as $user)
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-link" value="{{ $user->id }}" onclick="event.preventDefault(); showMore({{ $user->id }});"><i class="fa fa-info-circle"></i> Ver mais</button>
                    &nbsp; &nbsp;
                    <button type="button" class="btn btn-link text-danger" id="deleteBtn" value="{{ $user->id }}" onclick="event.preventDefault(); deleteUser({{ $user->id }});"><i class="fa fa-trash"></i> Deletar</button>
